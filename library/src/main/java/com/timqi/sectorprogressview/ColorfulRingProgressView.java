...
//            mStartAngle = a.getFloat(R.styleable.ColorfulRingProgressView_startAngle, 0)+270;
            mStartAngle = a.getFloat(R.styleable.ColorfulRingProgressView_startAngle, 0) + 135;
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.ColorfulRingProgressView_strokeWidth, dp2px(8));
...
//        canvas.drawArc(mOval, 0, 360, false, mPaint);
        canvas.drawArc(mOval, 135, 270, false, mPaint);

        mPaint.setShader(mShader);
//        canvas.drawArc(mOval, mStartAngle, mPercent * 3.6f, false, mPaint);
        canvas.drawArc(mOval, mStartAngle, mPercent * 2.7f, false, mPaint);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mShader = new LinearGradient(
                ...
                mFgColorStart, mFgColorEnd, Shader.TileMode.MIRROR);
    }
...
//        this.mStartAngle = mStartAngle + 270;
        this.mStartAngle = mStartAngle + 135;
        refreshTheLayout();
    }
}
